...
final class PersonDetail: Codable {
    ...
    init(adult: Bool, alsoKnownAs: [String], biography: String, birthday: String, deathday: String?, gender: Gender, homepage: String?, id: Int, imdbId: String, knownForDepartment: String, name: String, placeOfBirth: String, popularity: Double, profilePath: String) {
        self.adult = adult
...
extension PersonDetail {
    ...
    convenience init(from decoder: Decoder) throws {
        ...
        self.init(adult: adult, alsoKnownAs: alsoKnownAs, biography: biography, birthday: birthday, deathday: deathday, gender: gender, homepage: homepage, id: id, imdbId: imdbId, knownForDepartment: knownForDepartment, name: name, placeOfBirth: placeOfBirth, popularity: popularity, profilePath: profilePath)
    }
}
...
extension PersonDetail: CustomStringConvertible {
