//
//  MovieMatchesGroupedByFriendsResponse.swift
//  Filmatch
//
...
final class MovieMatchesGroupedByFriendsResponse: Sendable {
  let page: Int
  ...
  init(page: Int, results: [FriendMovieMatchesSingleResponse], resultsPerPage: Int, totalPages: Int, totalResults: Int) {
    self.page = page
...
extension MovieMatchesGroupedByFriendsResponse: Codable {
  ...
  convenience init(from decoder: any Decoder) throws {
    ...
    let results = try container.decode([FriendMovieMatchesSingleResponse].self, forKey: .results)
