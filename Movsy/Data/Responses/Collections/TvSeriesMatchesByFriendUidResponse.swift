//
//  TvSeriesMatchesByFriendUidResponse.swift
//  Movsy
//
...
final class TvSeriesMatchesByFriendUidResponse: Identifiable, Sendable {
  ...
  init(friendUid: String, page: Int, results: [TvSeriesMatchSingleResponse], resultsPerPage: Int, totalPages: Int, totalResults: Int) {
...
extension TvSeriesMatchesByFriendUidResponse: Codable {
