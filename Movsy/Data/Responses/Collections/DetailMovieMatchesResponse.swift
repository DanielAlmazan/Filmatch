//
//  DetailMovieMatchesResponse.swift
//  Movsy
//
...
final class DetailMovieMatchesResponse: Sendable {
  let page: Int
  let totalResults: Int
  let totalPages: Int
  let resultsPerPage: Int
  let results: [MovieMatchSingleResponse]
  let friend: MovsyUserResponse
  
  init(page: Int, totalResults: Int, totalPages: Int, resultsPerPage: Int, results: [MovieMatchSingleResponse], friend: MovsyUserResponse) {
    self.page = page
...
extension DetailMovieMatchesResponse: Codable {
  ...
  convenience init(from decoder: any Decoder) throws {
    ...
    let friend = try container.decode(MovsyUserResponse.self, forKey: .friend)
