...
@Observable
final class MovsyGoRepositoryImpl: MovsyGoRepository {
  private let datasource: MovsyGoDatasource
  
  init(datasource: MovsyGoDatasource) {
    self.datasource = datasource
  }
  
  func auth() async -> Result<MovsyUserResponse, any Error> {
